...
local Theme =
	...
	-- WINDOW SETTINGS 
	--------------------------------------------------------
	WindowCaptionFont          = "24358_MAIAN",   -- TO USE CUSTOM FONTS, MAKE SURE THAT 1. IT IS INSTALLED PROPERLY ON YOUR MAC OR PC, 2. PLACE COPY OF THE .TTF FILE IN YOUR PROJECTS ROOT FOLDER, 3. DECLARE THE FONT IN YOUR "build.settings" FILE PROPERLY. 
	WindowFontSize             = 56,            -- FONT SIZE OF WINDOW'S TITLE CAPTION
	WindowCaptionOffsetY       = -2,			-- OFFSET FROM WINDOW'S TOP BORDER TO THE CENTER OF THE CAPTION TEXT, ALSO AFFECTS ICON POSITION.
	WindowIconOffsetX          = 10,             -- LEFT MARGIN OF WINDOW'S TITLE ICON
	...
	WindowIconSize             = 72,			-- WINDOW TITLE BAR ICON SIZE IN PIXELS

	--------------------------------------------------------
	-- WIDGET SETTINGS 
	--------------------------------------------------------
	WidgetFont                 = "24358_MAIAN",   -- TO USE CUSTOM FONTS, MAKE SURE THAT 1. IT IS INSTALLED PROPERLY ON YOUR MAC OR PC, 2. PLACE COPY OF THE .TTF FILE IN YOUR PROJECTS ROOT FOLDER, 3. DECLARE THE FONT IN YOUR "build.settings" FILE PROPERLY. 
	WidgetFontSize             = 48,
	WidgetDisabledAlpha        = .5,			-- ALPHA VALUE (0.0 - 1.0) TO DISPLAY DISABLED WIDGETS.
	ButtonIconSize             = 58,			-- SIZE OF A BUTTON'S ICON IN PIXELS
	...
	ListIconSize               = 58,            -- SIZE OF A LIST ITEM'S ICON
