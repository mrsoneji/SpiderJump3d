...
function BitmapFontButton:new( options )
    ...
    local shadowColor   = options.shadowColor or {0,0,0,0}
    local shadowDistance = options.shadowDistance or 10
    ...
    button.bitmapfont:setExcludeCharacters({"©","®"})
    ...
    button.shadow                   = display.newRoundedRect( button, 0, 0, width, height, cornerRadius )
    button.shadow.x                 = shadowDistance
    button.shadow.y                 = shadowDistance
    button.shadow.strokeWidth       = strokeWidth
    button.shadow.isHitTestable     = hitTestable
    button.shadow:setFillColor( shadowColor[1],shadowColor[2],shadowColor[3],shadowColor[4] )
    button.shadow:setStrokeColor( shadowColor[1],shadowColor[2],shadowColor[3],shadowColor[4] )

    button:insert( button.shadow )
